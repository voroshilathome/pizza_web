...
exports.CartDrawerItem = function (_a) {
    var name = _a.name, price = _a.price, imageUrl = _a.imageUrl, quantity = _a.quantity, details = _a.details, className = _a.className, onClickCountButton = _a.onClickCountButton, onClickRemove = _a.onClickRemove;
    return (react_1["default"].createElement("div", { className: utils_1.cn('flex items-center justify-between', className) },
        ...
        react_1["default"].createElement("div", { className: "flex item-center gap-5 ml-20" },
            ...
            react_1["default"].createElement("button", { onClick: onClickRemove },
