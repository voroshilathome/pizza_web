...
var find_or_create_cart_1 = require("@/shared/lib/find-or-create-cart");
var update_cart_total_amount_1 = require("@/shared/lib/update-cart-total-amount");
function GET(req) {
    var _a;
...
function POST(req) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var token, userCart, data, findCartItem, updatedUserCart, resp, error_2;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, find_or_create_cart_1.findOrCreateCart(token)];
                case 1:
                    userCart = _c.sent();
                ...
                case 6:
                    _c.sent();
                    _c.label = 7;
                case 7: return [4 /*yield*/, update_cart_total_amount_1.updateCartTotalAmount(token)];
                case 8:
                    updatedUserCart = _c.sent();
                    resp = server_1.NextResponse.json(updatedUserCart);
                    resp.cookies.set('cartToken', token);
                    return [2 /*return*/, resp];
                case 9:
                    error_2 = _c.sent();
                    console.log('[CART_POST] Server error', error_2);
                    return [2 /*return*/, server_1.NextResponse.json({ message: 'Не удалось создать корзину' }, { status: 500 })];
